  ...
  methods: {
    ...
    getDate() {
      if (this.form.ct_name === "") {
        ...
        this.$http.get("/gp/material/Warehouse/select").then(res => {
          console.log(res);
        ...
        console.log(this.form.ct_name)
        this.$http
          .get("/gp/material/Warehouse/select"+this.form.ct_name)
          .then(res => {
            console.log(res);
            this.tableData = res.data.data;
          });
    ...
    addDate() {
      if (this.form != "") {
        this.$http
          .get("/gp/material/Warehouse/insert", {
            params: this.form
          })
          .then(res => {
            // console.log(res);
    ...
    upDate() {
      this.$http
        .get("/gp/material/Warehouse/update", {
          params: this.form
        })
        .then(res => {
          // console.log(res);
    ...
    deletData(index, row) {
      this.$http.get("/gp/material/Warehouse/delete" + row).then(res => {
        // console.log(res);
        this.getDate();
      });
    }
