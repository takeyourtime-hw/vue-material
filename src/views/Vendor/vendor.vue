  ...
  methods: {
    ...
    getDate() {
      if (this.form.ct_name === "") {
        ...
        this.$http.get("/gp/material/vendor/findone").then(res => {
          console.log(res);
        ...
        console.log(this.form.ct_name)
        this.$http
          .get("/gp/material/vendor/findone"+this.form.ct_name)
          .then(res => {
            console.log(res);
            this.tableData = res.data.data;
          });
    ...
    deletData(index, row) {
      this.$http.get("/gp/material/vendor/delete" + row).then(res => {
        // console.log(res);
        this.getDate();
      });
    }
