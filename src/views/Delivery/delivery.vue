  ...
  methods: {
    ...
    getDate() {
      if (this.form.ct_name === "") {
        ...
        this.$http.get("/gp/material/delivery/find").then(res => {
          console.log(res);
        ...
        console.log(this.form.ct_name);
        this.$http
          .get("/gp/material/delivery/find" + this.form.ct_name)
          .then(res => {
            console.log(res);
            this.tableData = res.data.data;
          });
    ...
    upDate() {
      this.$http
        .get("/gp/material/delivery/update", {
          params: this.form
        })
        .then(res => {
          // console.log(res);
    ...
    deletData(index, row) {
      this.$http.get("/gp/material/delivery/del" + row).then(res => {
        // console.log(res);
        this.getDate();
      });
    }
