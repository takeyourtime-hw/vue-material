  ...
  methods: {
    ...
    getDate() {
      if (this.form.ct_name === "") {
        ...
        this.$http.get("/gp/material/admission/search").then(res => {
          console.log(res);
        ...
        console.log(this.form.ct_name)
        this.$http
          .get("/gp/material/admission/search"+this.form.ct_name)
          .then(res => {
            console.log(res);
            this.tableData = res.data.data;
          });
    ...
    upDate() {
      this.$http
        .get("/gp/material/admission/update", {
          params: this.form
        })
        .then(res => {
          // console.log(res);
    ...
    deletData(index, row) {
      this.$http.get("/gp/material/admission/del" + row).then(res => {
        // console.log(res);
        this.getDate();
      });
    }
